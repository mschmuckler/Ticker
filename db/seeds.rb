...
bodies = [
  "<p>The company's pipeline consists of two research areas, <em>Chimeric Antigen Receptors</em> and T Cell Receptors. Its lead product candidate is CAR-T candidate axicabtagene ciloleucel, which is being evaluated for several kinds of lymphomas in five different studies right now. The therapy is currently under review by the FDA as well as by the European Medicines Agency, and approval is expected later this year (the FDA's action date is November 29). If the drug does indeed get approved, it could turn into a homerun for Kite Pharma and its (soon-to-be) owner Gilead: Peak sales of axicabtagene ciloleucel are expected to hit $7.9 billion in 2022 -- this alone would be equal to almost 30% of Gilead's current annual sales. Axicabtagene ciloleucel, which is estimated to be the most valuable CAR-T candidate right now could replace almost all of Gilead's HCV sales alone, as those are forecasted to hit $9 billion this year.</p>
